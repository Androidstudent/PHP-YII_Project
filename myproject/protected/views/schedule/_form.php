...
$ajax2 = array(
		...
		'type'=>'GET',
		'url'=>$this->createUrl('schedule/getClassType'),
		'data'=>array('id'=>'js:$(this).val()'),
		'update'=>'#Schedule_class_Type_Id'
);
?>
	...
	<div class="row">
		...
		<?php echo $form->dateField($model,'date', array('ajax'=>$ajax2)); ?>
		<?php echo $form->error($model,'date'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'class_Type_Id'); ?>
		<?php echo $form->dropDownList($model,'class_Type_Id',array()); ?>
